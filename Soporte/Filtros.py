...
'''
 Programa que nos ayuda a poner filtros basicos a imagenes, usando PyQt para crear la interfaz grafica. (La cual es muy basica)
 Hecho por Jonathan Suarez Lopez.
 # Cuenta: 313259595
'''
